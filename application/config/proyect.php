...
|
*/
$config['keywords'] = "World of warcraft,wow,private server,pvp";
$config['description'] = "Best World of Warcraft private server in the entire world!";
